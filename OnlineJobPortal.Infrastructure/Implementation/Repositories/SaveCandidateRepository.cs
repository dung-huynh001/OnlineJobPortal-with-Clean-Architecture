...
{
    public class SaveCandidateRepository : GenericRepository<SaveCandidate>, ISaveCandidateRepository
    {
        public SaveCandidateRepository(ApplicationDbContext context) : base(context)
        {
        }
    }
}
